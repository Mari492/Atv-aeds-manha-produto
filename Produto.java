...
public abstract class Produto implements Comparable<Produto> {
     ...
     @Override
     /**
      * Retorna o código identificador do produto. É um valor único para cada produto
      * (== chave).
      * 
      ...
      * @return booleano true/false conforme o parâmetro possua o mesmo código
      ...
      * Retorna um valor negativo se este produto tem um identificador anterior ao
      * outro produto,
      * valor positivo se o identificador é posterior ao do outro produto. Para o
      * mesmo produto, o
      * retorno é 0.
      * 
